                    ...
                    <div class="form-group">
                        <label for="sendmail">
                            <input
                                    type="checkbox"
                                    id="sendmail"
                                    value="SendMail" v-model="sentMail"> Send Mail
                        </label>
                        <label for="sendInfomail">
                            <input
                                    type="checkbox"
                                    id="sendInfomail"
                                    value="SendInfoMail" v-model="sentMail"> Send Infomail
                        </label>
                    </div>
...
<script>
    export default {
        data() { //es6 style
            return {
                userData: { // object two way binding to a property within an object
                    email: '', // two way binding
                    password: '', // two way binding
                    age: 27 // two way binding
                },
                message: 'A new text',
